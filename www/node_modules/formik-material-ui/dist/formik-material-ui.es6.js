...
var fieldToTextField = function (_a) {
    var field = _a.field, form = _a.form, variant = _a.variant, _b = _a.disabled, disabled = _b === void 0 ? false : _b, props = __rest(_a, ["field", "form", "variant", "disabled"]);
    var name = field.name;
    ...
    return __assign({}, props, field, { variant: variant, error: showError, helperText: showError ? fieldError : props.helperText, disabled: isSubmitting || disabled });
};
...
var fieldToCheckbox = function (_a) {
    var field = _a.field, isSubmitting = _a.form.isSubmitting, _b = _a.disabled, disabled = _b === void 0 ? false : _b, props = __rest(_a, ["field", "form", "disabled"]);
    return __assign({ disabled: isSubmitting || disabled }, props, field, { checked: field.value ? 'checked' : '', value: field.value ? 'checked' : '' });
};
